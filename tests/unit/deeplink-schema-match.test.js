...
describe('unit - DeepLinkSchemaMatch', function () {
  it('hasSchema', () => {
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitcoinil:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitcoinil:bc1qh6tf004ty7z7un2v5ntu4mkf630545gvhs45u7?amount=666&label=Yo'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitcoinil:BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7?amount=666&label=Yo'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo'));
    assert.ok(
    ...
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitilwallet:bitcoinil:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitilwallet:bitcoinil:bc1qh6tf004ty7z7un2v5ntu4mkf630545gvhs45u7?amount=666&label=Yo'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitilwallet:bitcoinil:BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7?amount=666&label=Yo'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitilwallet:BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE'));
    assert.ok(DeeplinkSchemaMatch.hasSchema('bitilwallet:BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo'));
    assert.ok(
      DeeplinkSchemaMatch.hasSchema(
        'bitilwallet:lightning:',
      ),
    );
  });
  ...
  it('isBitcoin Address', () => {
    ...
    assert.ok(DeeplinkSchemaMatch.isBitcoinAddress('BC1QYKCP2X3DJGDTDWELXN9Z4J2Y956NPTE0A4SREF'));
    assert.ok(DeeplinkSchemaMatch.isBitcoinAddress('bitcoinil:BC1QH6TF004TY7Z7UN2V5NTU4MKF630545GVHS45U7'));
    assert.ok(DeeplinkSchemaMatch.isBitcoinAddress('BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE'));
    assert.ok(DeeplinkSchemaMatch.isBitcoinAddress('BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo'));
  });
  ...
  it('isBoth Bitcoin & Invoice', () => {
    assert.ok(
      DeeplinkSchemaMatch.isBothBitcoinAndLightning(
        'bitcoinil:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4',
      ),
    );
    assert.ok(
      DeeplinkSchemaMatch.isBothBitcoinAndLightning(
        'BITCOINIL:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4',
      ),
    );
  });
  ...
  it('isSafelloRedirect', () => {
    assert.ok(DeeplinkSchemaMatch.isSafelloRedirect({ url: 'bitilwallet:?safello-state-token=TEST' }));
    assert.ok(!DeeplinkSchemaMatch.isSafelloRedirect({ url: 'bitilwallet:' }));
  });
  ...
  it('navigationForRoute', async () => {
    const events = [
      ...
      {
        argument: { url: 'bitcoinil:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG' },
        expected: ['SendDetailsRoot', { screen: 'SendDetails', params: { uri: 'bitcoinil:12eQ9m4sgAwTSQoNXkRABKhCXCsjm2jdVG' } }],
      },
      {
        argument: { url: 'BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' },
        expected: [
          'SendDetailsRoot',
          { screen: 'SendDetails', params: { uri: 'BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' } },
        ],
      },
      {
        argument: { url: 'bitilwallet:BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' },
        expected: [
          'SendDetailsRoot',
          { screen: 'SendDetails', params: { uri: 'BITCOINIL:BC1Q3RL0MKYK0ZRTXFMQN9WPCD3GNAZ00YV9YP0HXE?amount=666&label=Yo' } },
        ],
      ...
      {
        argument: {
          url: 'bitilwallet:?safello-state-token=TEST',
        },
        expected: [
          'BuyBitcoin',
          {
            safelloStateToken: 'TEST',
            uri: 'bitilwallet:?safello-state-token=TEST',
            walletID: undefined,
          },
        ],
      },
      {
        argument: {
          url: 'bitilwallet:setelectrumserver?server=electrum1.bitilwallet.com%3A50002%3As',
        },
        expected: [
          'ElectrumSettings',
          {
            server: 'electrum1.bitilwallet.com:50002:s',
          },
        ],
      },
      {
        argument: {
          url: 'bitilwallet:setlndhuburl?url=https%3A%2F%2Flndhub.herokuapp.com',
        },
        expected: [
          'LightningSettings',
          {
    ...
    const rez = await asyncNavigationRouteFor({
      url:
        'bitcoinil:1DamianM2k8WfNEeJmyqSe2YW1upB7UATx?amount=0.000001&lightning=lnbc1u1pwry044pp53xlmkghmzjzm3cljl6729cwwqz5hhnhevwfajpkln850n7clft4sdqlgfy4qv33ypmj7sj0f32rzvfqw3jhxaqcqzysxq97zvuq5zy8ge6q70prnvgwtade0g2k5h2r76ws7j2926xdjj2pjaq6q3r4awsxtm6k5prqcul73p3atveljkn6wxdkrcy69t6k5edhtc6q7lgpe4m5k4',
    });
  ...
  it('decodes bip21', () => {
    let decoded = DeeplinkSchemaMatch.bip21decode('bitcoinil:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar');
    ...
    decoded = DeeplinkSchemaMatch.bip21decode(
      'bitcoinil:bc1qnapskphjnwzw2w3dk4anpxntunc77v6qrua0f7?amount=0.0001&pj=https://btc.donate.kukks.org/BTC/pj',
    );
    assert.strictEqual(decoded.options.pj, 'https://btc.donate.kukks.org/BTC/pj');

    decoded = DeeplinkSchemaMatch.bip21decode('BITCOINIL:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar');
    assert.deepStrictEqual(decoded, {
      address: '1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH',
      options: {
        amount: 20.3,
  ...
  it('encodes bip21', () => {
    ...
    assert.strictEqual(encoded, 'bitcoinil:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH');
    encoded = DeeplinkSchemaMatch.bip21encode('1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH', {
      amount: 20.3,
      label: 'Foobar',
    });
    assert.strictEqual(encoded, 'bitcoinil:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar');
  });
  ...
  it('can decodeBitcoinUri', () => {
    ...
    assert.deepStrictEqual(DeeplinkSchemaMatch.decodeBitcoinUri('BITCOINIL:1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH?amount=20.3&label=Foobar'), {
      address: '1BgGZ9tcN4rm9KBzDn7KprQz87SZ26SAMH',
      amount: 20.3,
      memo: 'Foobar',
      payjoinUrl: '',
  ...
  it('can work with some deeplink actions', () => {
    ...
    assert.strictEqual(
      DeeplinkSchemaMatch.getServerFromSetElectrumServerAction('bitilwallet:setelectrumserver?server=electrum1.bitilwallet.com%3A50002%3As'),
      'electrum1.bitilwallet.com:50002:s',
    );
    assert.strictEqual(
      DeeplinkSchemaMatch.getServerFromSetElectrumServerAction('setelectrumserver?server=electrum1.bitilwallet.com%3A50002%3As'),
      'electrum1.bitilwallet.com:50002:s',
    );
    assert.strictEqual(
      DeeplinkSchemaMatch.getServerFromSetElectrumServerAction('ololo:setelectrumserver?server=electrum1.bitilwallet.com%3A50002%3As'),
      false,
    );
    assert.strictEqual(
      DeeplinkSchemaMatch.getServerFromSetElectrumServerAction('setTrololo?server=electrum1.bitilwallet.com%3A50002%3As'),
      false,
    );

    assert.strictEqual(
      DeeplinkSchemaMatch.getUrlFromSetLndhubUrlAction('bitilwallet:setlndhuburl?url=https%3A%2F%2Flndhub.herokuapp.com'),
      'https://lndhub.herokuapp.com',
    );
    assert.strictEqual(
      DeeplinkSchemaMatch.getUrlFromSetLndhubUrlAction('bitilwallet:setlndhuburl?url=https%3A%2F%2Flndhub.herokuapp.com%3A443'),
